    ...
    public class MultiTag : MonoBehaviour
    {
        ...
        public class Inspector : InspectorBase<MultiTag>
        {
            ...
            protected override void OnEnable()
            {
                ...
                tags.drawElementCallback = DrawTagElement;
            }
            ...
            void DrawTagElement(Rect rect, int index, bool isActive, bool isFocused)
            {
                EditorGUI.PropertyField(GUIArea.ProgressLine(ref rect), tags.GetArrayElement(index), new GUIContent("Tag " + (index + 1)));
            }
        }
#endif
    }
